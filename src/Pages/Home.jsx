      ...
      >
        ...
        <div className="fixed bottom-0 flex items-center justify-center w-[75vw] sm:w-[60vw] m-auto">
          <div className="">
            ...
            />
            <div
              className="w-[30px] h-[30px] bg-violet-900 rounded-[29px] pb-1 pl-1 flex justify-center items-center absolute bottom-[0%] right-[-1rem] sm:right-[1rem] transform translate-y-[-90%] cursor-pointer"
