...
const ReminderModal = () => {
  ...
  const handleSubmit = (e) => {
    ...
    console.log("Form submitted:", { title, additionalInfo, emails });
    ...
    <div className="fixed top-0 left-0 w-full h-full  items-center  bg-gray-800 bg-opacity-50  flex justify-center  ">
      ...
      <div className="md:w-[40rem] p-8 bg-white justify-center items-center mx-20">
        <form
          ...
          className="mt-6 grid justify-center items-center overflow-hidden"
        >
          ...
          <div className="flex justify-between">
            ...
            <button
              type="submit"
              className="bg-[#300193] px-4 py-1 text-white text-md rounded-full"
            >
              Save
            </button>
          </div>
              ...
              <div>
                <div className="absolute  mt-12  flex justify-center items-center gap-2">
                  {emails.map((email, index) => (
                    <div
                      key={index}
                      className="bg-[#300193] px-2 py-1 text-xs rounded-full text-white"
                    >
                      {email}
                      <button
                        onClick={() => handleRemoveEmail(index)}
                        className="absolute pl-2 text-[black] mb-8"
                      >
                        &times;
                      </button>
                    </div>
